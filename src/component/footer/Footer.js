...
const Footer = () => {
    return (
        <>
            <footer className="pt-24 pb-12 border-t-2 border-pink/40 ">
                    ...
                    <div className="flex flex-wrap">
                        <div className="mb-12 w-full px-4 font-medium text-primary md:w-1/3 [&>p]:mt-1">
                            <img
                                src={logo}
                                alt=""
                                className="w-[10rem] lg:w-28 mb-4 brightness-150 hover:animate-pulse"
                            />
                            <h3 className="mb-2 text-3xl lg:text-2xl font-bold">
                                RCTN-KS05
                            </h3>
